...
class _GasStationListState extends State<GasStationList> {
  ...
  int _comparePrices(GasStationData a, GasStationData b) {
    String brandA = getBrandFromName(a.name);
    String brandB = getBrandFromName(b.name);
    double priceA =
        _prices[brandA]?[widget.favoriteFuelType] ?? double.infinity;
    double priceB =
        _prices[brandB]?[widget.favoriteFuelType] ?? double.infinity;
